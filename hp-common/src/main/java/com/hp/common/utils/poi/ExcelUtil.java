...
public class ExcelUtil<T>
{
     ...
     * @return 转换后集合
     */
    public List<T> importExcels(InputStream is) throws Exception
    {
        return importExcels(StringUtils.EMPTY, is);
    }
     ...
     * @return 转换后集合
     */
    public List<T> importExcels(String sheetName, InputStream is) throws Exception
    {
        this.type = Type.IMPORT;
        this.wb = WorkbookFactory.create(is);
        List<T> list = new ArrayList<T>();

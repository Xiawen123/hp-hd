...
public class Result {
    ...
    public static String error(Integer code, Object result) {
        return (new Result(code.intValue(), Status.ERROR.name(), (String)null, result)).toString();
    }

    public static String error(Integer code) {
        return (new Result(code.intValue(), Status.ERROR.name(), (String)null, (Object)null)).toString();
    }
    ...
    public static String ok(Integer code, Object result) {
        return (new Result(code.intValue(), Status.OK.name(), (String)null, result)).toString();
    }

    public static String ok(Integer code) {
        return (new Result(code.intValue(), Status.OK.name(), (String)null, (Object)null)).toString();
    }
    ...
    public static String ok(Object result) {
        return (new Result(0, Status.OK.name(), "success", result)).toString();
    }
